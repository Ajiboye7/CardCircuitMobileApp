  ...
  return (
    <SafeAreaView>
      <ScrollView>
        ...
        <Text className="text-white text-[32px] font-sfProRoundedBold my-5">
          My Profile
        </Text>
        ...
        <View className=" bg-tertiary-20 flex gap-4 ">
          <View className="flex flex-row justify-between items-center border-b border-fontColor-gray pb-5">
